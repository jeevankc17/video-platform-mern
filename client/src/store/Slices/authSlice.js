...
export const createAccount = createAsyncThunk("register", async (data) => {
    ...
    try {
        const response = await axiosInstance.post(`${server}/users/register`, formData);
...
export const userLogin = createAsyncThunk("login", async (data) => {
    try {
        console.log(data);
        const response = await axiosInstance.post(`${server}/users/login`, data);
...
export const userLogout = createAsyncThunk("logout", async () => {
    try {
        const response = await axiosInstance.post(`${server}/users/logout`);
        return response.data;
    } catch (error) {
        toast.error(error?.response?.data?.error);
        throw error;
...
export const getCurrentUser = createAsyncThunk("getCurrentUser", async () => {
    const response = await axiosInstance.get(`${server}/users/current-user`);
...
export const updateCoverImg = createAsyncThunk(
    ...
    async (coverImage) => {
        try {
            const response = await axiosInstance.patch(
                `${server}/users/update-coverImage`,
                coverImage
            );
            toast.success(response.data?.message);
            return response.data.data;
